...
export default function AcademyHero() {
  return (
    <section className="bg-violet-bg pt-12 pb-10 md:pt-16 md:pb-12">
      <Container>
        <div className="mx-auto max-w-[760px] text-center">
          <h1 className="font-display text-[2rem] leading-tight text-foreground md:text-h3">
            Modash Influencer Marketing Academy
          </h1>
          <p className="mx-auto mt-5 max-w-[640px] text-body-sm text-foreground/75 md:text-body">
